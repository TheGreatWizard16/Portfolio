  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (!serviceId || !templateId || !publicKey) {
        throw new Error(
          "Email service is not configured. Missing VITE_EMAILJS_* env variables."
        );
      }
      ...
      const templateParams = {
        ...
        // Only include these if your template actually uses them:
        // to_email: "horladimeji10@gmail.com",
        // user_login: "",
      };
      ...
      // EmailJS often returns useful text in err.text
      const msg =
        err?.text ||
        err?.message ||
            ...
            <motion.div variants={containerVariants} className="space-y-6">
              ...
              <motion.div variants={itemVariants} className="flex items-start">
                ...
                <div>
                  ...
                  <a
                    href="mailto:horladimeji10@gmail.com"
                    className="text-muted hover:text-light transition-colors"
                  >
                    horladimeji10@gmail.com
                  </a>
                </div>
              </motion.div>
              ...
              <motion.div variants={itemVariants} className="flex items-start">
                ...
                <div>
                  ...
                  <div className="flex gap-3 mt-2">
                    {/* GitHub */}
                    <a
                      href="https://github.com/TheGreatWizard16"
                      target="_blank"
                    ...
                    {/* LinkedIn */}
                    <a
                      href="https://www.linkedin.com/in/segun-oladimeji/"
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:opacity-80 transition-opacity"
                    >
                    ...
                    {/* Twitter / X (fix empty href) */}
                    <a
                      href="https://x.com/" // replace with your profile or remove the icon
                      target="_blank"
                      rel="noopener noreferrer"
                      className="hover:opacity-80 transition-opacity"
                    >
